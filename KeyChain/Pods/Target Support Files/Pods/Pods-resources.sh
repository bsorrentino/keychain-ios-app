    ...
    *)
      ...
      ;;
          ...
          install_resource "UIXML/back24x24.png"
                    ...
                    install_resource "UIXML/MailDataEntryCell.xib"
                    install_resource "UIXML/PushDateEntryCell.xib"
                    install_resource "UIXML/PushFormDataEntryCell.xib"
                    install_resource "UIXML/PushTextEntryCell.xib"
                    install_resource "UIXML/PushWebViewEntryCell.xib"
                    install_resource "UIXML/SwitchDataEntryCell.xib"
                    install_resource "UIXML/TextDataEntryCell.xib"
