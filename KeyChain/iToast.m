...
//
//  Updated by bsorrentino 9/16/11
//
...
- (void) show {
    ...
    [self show:window origin:point];
    
}

- (void) show:(UIView *)window origin:(CGPoint)point {
    ...
    CGSize textSize = [text boundingRectWithSize:CGSizeMake(280, 60) options:NSStringDrawingUsesLineFragmentOrigin attributes:nil context:nil].size;
